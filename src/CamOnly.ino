// CAM Only Portions Copyright 2019 Robert Mech - rwmech@gmail.com 
// Based on the WebServer reference application by Espressif Systems.
...
// Configuration - Modify the device name and network SSID and password. 
const char* DEVICE_NAME = "OCTO_CAM01";
const char* ssid = "Boganville";
const char* password = "potsticker";
// End Configuration

const int lampledPin = 4;
